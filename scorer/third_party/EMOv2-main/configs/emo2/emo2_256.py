...
# model.model_kwargs = dict(pretrained=False, checkpoint_path='runs/emo2/cls/CLSTrainer_EMO2_20M_k5_hybrid_256_ImageFolderLMDB_20240521-155239/ckpt_210.pth', ema=False, strict=True, num_classes=data.nb_classes)
