...
from .basic_modules import get_norm, get_act, ConvNormAct, LayerScale2D
...
class iiRMB(nn.Module):
	...
	def __init__(self, dim_in, dim_out, norm_in=True, has_skip=True, exp_ratio=1.0, norm_layer='bn_2d',
		...
		if dw_ks > 0:
			...
			self.conv_local = ConvNormAct(dim_mid, dim_mid, kernel_size=dw_ks, stride=stride, groups=dim_mid, norm_layer='ln_2d', act_layer='gelu', inplace=inplace)
		else:
